...
- [llama-models](https://github.com/meta-llama/llama-models) - Foundation models including Llama 3.1
- [llama-toolchain](https://github.com/meta-llama/llama-toolchain) - Model development interfaces
- [llama-agentic-system](https://github.com/meta-llama/llama-agentic-system) - End-to-end Llama Stack
