---
title: Model Card
description: Technical details, architecture, and performance benchmarks for Llama 2 models
---
...
|---|---|---|---|---|---|---|
| Llama 2 | *A new mix of publicly available online data* | 7B | 4k | ✗ | 2.0T | 3.0 x 10⁻⁴ |
| Llama 2 | *A new mix of publicly available online data* | 13B | 4k | ✗ | 2.0T | 3.0 x 10⁻⁴ |
...
**Carbon Footprint:** Pretraining utilized a cumulative 3.3M GPU hours of computation on hardware of type A100-80GB (TDP of 350-400W). Estimated total emissions were 539 tCO₂eq, 100% of which were offset by Meta's sustainability program.
...
- *MATH:* We report the average of the GSM8K (8 shot) and MATH (4 shot) benchmarks at the top 1.
...
<Warning>
Before deploying any applications of Llama 2, developers should perform safety testing and tuning tailored to their specific applications of the model.
</Warning>

Please see the [Responsible Use Guide](https://ai.meta.com/llama/responsible-use-guide/) for additional guidance on safe deployment practices.
